...
describe('Service Tests', () => {
  describe('ZamowienieWpis Service', () => {
    let injector: TestBed;
    let service: ZamowienieWpisService;
    let httpMock: HttpTestingController;
    let elemDefault: IZamowienieWpis;
    let expectedResult;
    beforeEach(() => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a ZamowienieWpis', () => {
        ...
        service
          .create(new ZamowienieWpis(null))
          .pipe(take(1))
          .subscribe(resp => (expectedResult = resp));
      ...
      it('should update a ZamowienieWpis', () => {
        const returnedFromService = Object.assign(
          {
            ilosc: 1,
            cena: 1,
      ...
      it('should return a list of ZamowienieWpis', () => {
        const returnedFromService = Object.assign(
          {
            ilosc: 1,
            cena: 1,
      ...
      it('should delete a ZamowienieWpis', () => {
